...
<?= head(['title' => 'Returned & Deposit Management']) ?>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Return & Deposit Management</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item active">Return & Deposit Management</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-12">
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  <h5 class="card-title">Returned & Deposit <span>| Today</span></h5>
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                      <tr>
                        <td>1</td>
                        <td><a href="#" class="text-primary fw-bold">Ric Charles Paquibot</a></td>
                        <td>5</td>
                        <td>PHP 500</td>
                        <td>No Damage</td>
                        <td>02, Feb 2025, 9:03am</td>
                        <td>10, Feb 2025, 3:03pm</td>
                        <td>Admin</td>
                        <td>Archive</td>
                      </tr>
                    </tbody>
